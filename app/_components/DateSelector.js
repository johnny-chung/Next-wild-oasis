...
function DateSelector({ settings, bookedDate, cabin }) {
  ...
  // since range is stored in context, all cabin share same range
  // need to reset range to empty if it is already booked in certain cabin
  ...
  return (
    <div className="flex flex-col justify-between">
      <DayPicker
        ...
        onSelect={(range) => selectDateRange(range)}
        disabled={(curDate) =>
